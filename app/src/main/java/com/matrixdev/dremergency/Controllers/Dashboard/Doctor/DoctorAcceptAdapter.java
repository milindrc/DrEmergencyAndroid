...
public class DoctorAcceptAdapter extends RecyclerView.Adapter<DoctorAcceptAdapter.VH> {
    ArrayList<DoctorRequestData> data;
    DoctorDashboard activity;
    AcceptFragment fragment;

    public DoctorAcceptAdapter(ArrayList<DoctorRequestData> data, DoctorDashboard activity, AcceptFragment fragment) {
        this.data = data;
    ...
    public class VH extends RecyclerView.ViewHolder {
        ...
        public VH(View itemView) {
            ...
            requestAccept.setText("Blacklist");
        }
    ...
    private void blacklist(DoctorRequestData data) {
        ...
        manager.getStringPostResponse(fragment.ACCEPT,Constants.URL_DOCTOR_REQUEST_BLACKLIST,param);
    }
