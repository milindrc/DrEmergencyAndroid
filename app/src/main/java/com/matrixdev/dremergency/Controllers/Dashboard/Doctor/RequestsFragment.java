 ...
 */
public class RequestsFragment extends Fragment implements ServerResponseListener {
    ...
    private void fetchRequests() {
        ...
        apiManager.getStringPostResponse(DOCTOR_REQUESTS, Constants.URL_DOCTOR_REQUESTS, param);
    ...
    private void showRequests() {
        requestList.setLayoutManager(new LinearLayoutManager(activity));
        adapter = new DoctorRequestAdapter(requests, activity, this);
